...
class AuctionListingsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(0, len(listings_auctioned)-1):
            ...
            item["property_id"] = listings_auctioned[i].css(".padb-listing-id::text").getall()[1]
            ...
            item["property_value"] = listings_auctioned[i].css(".padb-property-value::text").getall()
            item["property_auctiondetails"] = listings_auctioned[i].css(".padb-auction-details::text").getall()
            item["property_ratingvalue"] = listings_auctioned[i].css(".padb-property-rating-value::text").getall()
